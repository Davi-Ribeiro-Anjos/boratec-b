    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('destino', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='palete_movimento_destino', to='filiais.filiais')),
                ('origem', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='palete_movimento_origem', to='filiais.filiais')),
            ],
            options={
