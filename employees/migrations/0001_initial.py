    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rg', models.CharField(max_length=15, null=True, validators=[employees.models.only_int])),
                ('cpf', models.CharField(max_length=11, null=True, validators=[employees.models.only_int])),
                ('cnpj', models.CharField(max_length=14, null=True, validators=[employees.models.only_int])),
                ...
                ('status', models.CharField(choices=[('ATIVO', 'Ativo'), ('DEMITIDO', 'Demitido'), ('AFASTADO', 'Afastado')], default='ATIVO', max_length=10)),
                ...
                ('dismissal', models.OneToOneField(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='employee', to='employees_dismissals.employeesdismissals')),
